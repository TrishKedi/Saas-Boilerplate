...
export default function Dashboard() {
  ...
  const handleLogout = () => {
    useLogout(); // ✅ You might want to call this as a function
    router.push("/");
  };
        ...
        >
          ...
          <Card>
            ...
            <CardContent>
              ...
              <Button variant="destructive" className="ml-4" onClick={handleLogout}>
                Logout
              </Button>
              <Button
                variant="outline"
                onClick={() => createStripeUser()}
                className="mt-2"
              >
                {subscribStatus === "pending" ? "Processing..." : "Subscribe Now"}
              </Button>
            </CardContent>
          </Card>
        </motion.div>
